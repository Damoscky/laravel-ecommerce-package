...
use SbscPackage\Ecommerce\Notifications\PendingCustomerNotification;
...
class RegisterController extends BaseController
{
    ...
    public function register(Request $request)
    {
        ...
        try {
            ...
            Notification::route('mail', $request->email)->notify(new PendingCustomerNotification($maildata));
            DB::commit();
